...
class Invoice(ActiveModel):
    ...
    company_city_snapshot = models.CharField(
        max_length=100,
        blank=True,
        default="",
        verbose_name="Ciudad Empresa (Snapshot)",
    )

    company_receipt_footer_snapshot = models.TextField(
        blank=True,
        default="",
        verbose_name="Pie de Ticket Empresa (Snapshot)",
    )
